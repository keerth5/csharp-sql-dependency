...
namespace SampleApp
{
    public class DboSchemaUsageExample
    {
        ...
        // ❌ Violation: Hard-coded dbo schema reference
        public void Bad_HardCodedDbo()
        {
            string sql = "SELECT Name, Role FROM dbo.Users WHERE IsActive = 1";
        ...
        // ❌ Violation: Dynamic dbo schema with string concatenation
        public void Bad_DynamicDbo(string tableName)
        {
            string sql = $"SELECT Name, Role FROM dbo.{tableName} WHERE IsActive = 1";
        ...
        // ✅ Compliant: Parameterized query without explicit schema
        ...
        // ✅ Compliant: EF Core abstraction without dbo schema
