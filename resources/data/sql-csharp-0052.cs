...
namespace SampleApp
{
    public class ConvertFunctionUsageExample
    {
        ...
        // ❌ Violation: Hard-coded CONVERT() function in SQL Server
        public void Bad_HardCodedConvert()
        {
            string sql = "SELECT Name, CONVERT(VARCHAR, CreatedDate, 120) AS CreatedDateStr FROM Users";
        ...
        // ❌ Violation: Dynamic SQL with CONVERT() concatenation
        public void Bad_DynamicConvert(string columnName)
        {
            string sql = $"SELECT Name, CONVERT(VARCHAR, {columnName}, 120) AS ConvertedValue FROM Users";
        ...
        // ✅ Compliant: Use application-side data conversion
