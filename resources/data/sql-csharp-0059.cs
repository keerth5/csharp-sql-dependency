...
namespace SampleApp
{
    public class TempTableUsageExample
    {
        ...
        // ❌ Violation: Using temporary table in SQL Server
        public void Bad_UseTempTable()
        {
            string sql = @"
        ...
        // ❌ Violation: Dynamic SQL using temporary table
        public void Bad_DynamicTempTable(string tableName)
        {
            string sql = $@"
                CREATE TABLE #TempTable (Id INT, Name NVARCHAR(100));
                INSERT INTO #TempTable (Id, Name) SELECT Id, Name FROM {tableName};
        ...
        // ✅ Compliant: EF Core LINQ queries without temp tables
